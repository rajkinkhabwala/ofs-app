...
export async function createAssignmentSubmission(assignmentSubmission: CreateAssignmentSubmissionsInput) {
    return await API.graphql<GraphQLQuery<CreateAssignmentSubmissionsMutation>>(graphqlOperation(mutations.createAssignmentSubmissions, { input: assignmentSubmission }))
}
