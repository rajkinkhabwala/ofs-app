...
export default function CoursesCreateForm(props) {
  ...
  const resetStateValues = () => {
    setCourse_name(initialValues.course_name);
    setCourse_code(initialValues.course_code);
    setCourse_visibility(initialValues.course_visibility);
    setCourse_start_date(initialValues.course_start_date);
    setCourse_end_date(initialValues.course_end_date);
    setCourse_description(initialValues.course_description);
    setCourse_image(initialValues.course_image);
    setCourse_format(initialValues.course_format);
    setCourse_credit(initialValues.course_credit);
    setErrors({});
  };
  const validations = {
