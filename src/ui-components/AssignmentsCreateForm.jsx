...
export default function AssignmentsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAssignment_desc(initialValues.assignment_desc);
    setResubmit(initialValues.resubmit);
    setTeacher(initialValues.teacher);
    setMax_bytes(initialValues.max_bytes);
    setTime_due(initialValues.time_due);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Assignments(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "AssignmentsCreateForm")}
      {...rest}
    >
      <TextField
